	...
	$("#flinfo_table tbody tr").each(function(){
		if($(this).find("input").is(":checked")){
			...
			for (var i in idArr) {
					...
					content+="<td align='center' valign='middle' style='width: 79px; height: 24px;'  ><input id='number' type='text' style='width: 79px; height: 24px;' class='br'/></td>";
					content+="<td align='center' valign='middle' style='width: 79px; height: 24px;' ><input id='sellprice' type='text' style='width: 79px; height: 24px;' class='br'/></td>";
					content+="</tr>";
