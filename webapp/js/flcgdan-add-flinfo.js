...
$(function () {
    flgysid= getQueryString("flgysid");
	...
	$("#flinfo_table tbody tr").each(function(){
		if($(this).find("input").is(":checked")){
			...
			for (var i in idArr) {
					...
					content+="<td align='center' valign='middle' style='width: 80px; height: 24px;' id='categroymc'  >"+idArr[i].flcode+"</td>";
					content+="<td align='center' valign='middle' style='width: 120px; height: 24px;' id='categroymc'  >"+idArr[i].categroymc+"</td>";
