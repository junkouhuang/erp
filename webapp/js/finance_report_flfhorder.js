...
function search(){
	...
	//初始化表格
    $("#table").bootstrapTable('refresh', {url:pageContext+"/financeReportController/getFlfhorderList"});
}
...
function requestExportExcel(){
	window.location.href="financeReportController/exportFlfhorederExcel?mdcode="+mdCode
	+"&startTime="+startTime
	+"&endTime="+endTime;
}
