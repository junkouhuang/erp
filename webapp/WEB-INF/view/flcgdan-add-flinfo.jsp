...
<body class="gray-bg">
                           		...
                           		<div class="">
						            <form class="form-horizontal"  id="commentForm" >
										<table class="table mb-0"  data-show-columns="false">
											<tr>
												<td width="80">辅料名：</td>
												<td width="150"><input type="text" name="categroymc" id="categroymc" class="form-control radius"></td>
												<td width="80">编码：</td>
												<td width="150"><input type="text" name="flcode" id="flcode" class="form-control radius"></td>
								      			<td width="80">条码：</td>
								      			<td width="150"><input type="text" name="barcode" id="barcode"  class="form-control radius"></td>
								      			<td width="150"></td>
								      		</tr>
								      		<tr>
								      			<td width="80">价格段：</td>
								      			<td width="60"><input type="text" name="minSellprice" id="minSellprice"  class="form-control radius"></td>
								      			<td width="60" align="center"><span class="glyphicon glyphicon-resize-horizontal"></span></td>
								      			<td width="60"><input type="text" name="maxSellprice" id="maxSellprice" class="form-control "></td>
	...
	<script src="${pageContext.request.contextPath}/js/flcgdan-add-flinfo.js"></script>
</body>
</html>