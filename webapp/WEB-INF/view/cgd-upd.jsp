...
<div class="page-container">
	<fieldset>
		<form action="" >
			<input type="hidden" id="cgid"></input>
			<table class="table mb-0" >
				<tr>
				<td width="80" class="glyphicon-asterisk">单据号：</td><td><input type="text" name="ordercode" id="ordercode" class="form-control radius" onkeyup="value = value.replace(/[\u4e00-\u9fa5]/g, '')"></td>
				...
				<%--<td>车辆信息：</td><td> <input type="text" name="clxx" id="clxx"  class="form-control radius"></td>--%>
...
<div style="min-width:694px;margin-left:3px;">
	<table id="dg" class="easyui-datagrid"  style="width:100%;height:150px"
		iconCls="icon-edit" singleSelect="true"
			idField="itemid"  method="get" toolbar="#tb">
		<thead>
			<tr>
				<th  data-options="field:'id',width:160,align:'center',hidden:'true'">id</th>
				...
				<th  data-options="field:'cpsl',width:80,align:'center',editor:{type:'numberbox',options:{precision:0}}">数量</th>
				<th  data-options="field:'dj',width:80,align:'center',editor:{type:'numberbox',options:{precision:1}}">单价</th>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/cgd-upd.js" ></script>
</html>