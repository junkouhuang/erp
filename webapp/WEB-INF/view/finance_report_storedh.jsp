...
<body class="gray-bg">
                          ...
                          <form class="form-horizontal">
                        	<div class="row" >
							      <div class="col-lg-1 col-md-1  text-right pt-7" >
								    	<label for="fstoreid" >调出门店：</label>
								  </div>
                                  <div class="col-lg-2 col-md-2 ">
                                      <select class="combobox form-control" type="text" name="fstoreid" id="fstoreid">
                                      </select>
                                  </div>
                                <div class="col-lg-1 col-md-1  text-right pt-7" >
                                    <label for="tstoreid" >调入门店：</label>
                                </div>
                                <div class="col-lg-2 col-md-2 ">
                                    <select class="combobox form-control" type="text" name="tstoreid" id="tstoreid">
                                    </select>
                                </div>
								  <div class="col-lg-1 col-md-1  text-right pt-7" >
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/finance_report_storedh.js" ></script>
