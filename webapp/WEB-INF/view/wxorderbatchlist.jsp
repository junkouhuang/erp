            ...
            <div class="ibox ">
                ...
                <div class="ibox-title">
                    <form class="form-horizontal m-t" id="orderlistForm">
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 ">
                                <input class="form-control layer-date" name="fbcode"  id="fbcode" type="text" placeholder="发布号">
                            </div>
                            ...
                            <div class="col-lg-1 col-md-1  text-right pt-7">
                                <label for="inputEmail3" class="">催款单号：</label>
                            </div>
                            <div class="col-lg-2 col-md-2 ">
                                <input class="form-control layer-date" name="wxamountcode"  id="wxamountcode" type="text" placeholder="催款单号">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 ">
                                <select class="combobox form-control" name = "status" id = "status">
                                    ...
                                    <option value="1">生成发货单</option>
                                    <option value="2">客服审核</option>
                            ...
                            <div class="col-lg-2 col-md-2">
                                <select class="combobox form-control" name = "paystatus" id = "paystatus">
                                    <option ></option>
                        ...
                        <div class="row">
                            <div class="col-lg-1 col-md-1  text-right pt-7">
                                <label for="isamount">合成催款单：</label>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <select class="combobox form-control" name = "isamount" id = "isamount">
                                    <option ></option>
                ...
                <div class="ibox-content">
                    <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                        <button class="btn btn-gold glyphicon glyphicon-compressed" onclick="bindWxAmount()">合成催款单</button>
                       <%-- <button class="btn btn-danger glyphicon glyphicon-plus" onclick="addWxNoOrderFhorder()">合成发货单</button>--%>
                        <button class="btn btn-info glyphicon glyphicon-remove" onclick="revokeWxOrderBatch()">撤销订单批次</button>
                    </div>
                    <table class="table" id="table" data-height="510" data-mobile-responsive="true">

                    </table>
                    <div>
                        <i class="fa fa-square text-success">待处理</i>
                        <i class="fa fa-square text-danger">已生成发货单</i>
                        <i class="fa fa-square text-navy">客服审核</i>
                        <i class="fa fa-square text-MediumPurple">财务审核</i>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/wxorderbatchlist.js"></script>
</body>
