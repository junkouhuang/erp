	...
	<div class="easyui-tabs" style="width:99%;height:408px;margin-left:4px;">
		<div title="基础信息" style="padding:10px">
			 <form id="sort_out_table" name="sort_out_table" method="post">
		    	<table cellpadding="5">
					<tr>
						<td  class="pb-3">建批次?：</td>
						<td  class="pb-3"><input type="checkbox" value="0" name="withbatch" id="withbatch" onchange="withbatchonchange(this)"/></td>
						<td  class="pb-3">批次号：</td>
						<td  class="pb-3"><input class="easyui-textbox" disabled id="batchcode" name="batchcode" ></input></td>
					</tr>
		    		<tr>
						...
						<td  class="pb-3">
							<select id='lx' name="lx" class='easyui-combobox'  data-options="width:154,required:true,missingMessage:'请选择产品类型'">
		    		...
		    		<tr>
		    			...
		    			<td class="pb-3"><input class="easyui-numberspinner" value="1.0" id="sellrate"  name="sellrate"  min="0" max="1"  precision="1" increment="0.1" data-options="required:true,validType:'text',prompt:'0.5表示5折,1表示不打折',width:154,missingMessage:'请选择零售折扣'" /></td>
		    		</tr>
		    		<tr>
	    				<td class="pb-3">批发折扣:</td>
		    			<td class="pb-3"><input class="easyui-numberspinner" value="0.5" id="rate" name="rate"  min="0" max="1"    precision="1"    increment="0.1" data-options="required:true,validType:'text',prompt:'0.5表示5折,1表示不打折',width:154,missingMessage:'请选择批发折扣'" ></input></td>
		    		...
		    		<tr>
						...
						<td class="pb-3">季节:</td>
						<td class="pb-3">
							<select class='easyui-combobox' data-options='width:154' id="wllb" name="wllb">
		    		...
		    		<tr>
						...
						<td class="pb-3">备注:</td>
						<td class="pb-9" colspan="3"><input class=" easyui-textbox" id="bz" name="bz" data-options="validType:'text',prompt:'请填写备注',width:365,missingMessage:'请填写备注'" ></input></td>
					</tr>
		    	</table>
	    	</form>
		</div>
		...
		<div title="明细" style="padding:1px">
			<table id="dg" class="easyui-datagrid" data-options="onClickCell: onClickCell,width:550,height:373,singleSelect:true,">
				<thead>
					<tr>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/spb_create_record.js"></script>
</body>
</html>