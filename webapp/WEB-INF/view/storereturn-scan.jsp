            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                            <button class="btn btn-warning glyphicon glyphicon-share-alt" onclick="exportStoreReturnExcel()">导出退货件数统计报表</button>
                    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/storereturn-scan.js" ></script>
