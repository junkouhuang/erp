...
<body class="gray-bg">
                ...
                <div class="ibox ">
                        ...
                        <div class="ibox-title">
                        	<div class="row" >  
							      ...
							      <div class="col-lg-2 col-md-2 ">  
							        <input class="form-control layer-date" type="text" placeholder="请选择时间段进行打印"  id="time">  
							      </div>  
                        ...
                        <div class="ibox-content">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                     <button onclick="printScrapOrder()" class="btn btn-outline btn-default">
                                ...
                                <table  class="tab_css_1" id="scrap_order_report" data-height="510" data-mobile-responsive="true">
                                </table>
                        </div>
                        <!-- End Example Events -->
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/scrap_order_report.js" ></script>
