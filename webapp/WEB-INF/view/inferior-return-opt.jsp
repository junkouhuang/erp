    ...
    <div class="col-sm-12">
        <div class=" ">
            <div style="margin-left: 10px;">
                次品退货单号:<input class="easyui-textbox" id="returncode" name="returncode"
                           data-options="required:true,validType:'text',width:200,missingMessage:'请输入次品退货单号'" />
                <input style="border-radius: 15px;color: saddlebrown" type="button" value="获取退货单信息" onclick="loadSpbatchetailinfo();">
            </div>
            <!-- End Example Events -->
            <div style="width:99%;margin-left:3px;">
                <table id="cgreturn-tb" class="easyui-datagrid"  style="width:100%;height:55px;"
                       data-options="
                            iconCls: 'icon-tip',
                            singleSelect: true,
                            toolbar: '#tb',
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/inferior-return-opt.js"></script>
</body>
</html>