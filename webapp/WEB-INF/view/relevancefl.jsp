...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class=" ">
										...
										<table class="table mb-0"  data-show-columns="false">
											<tr>
												...
												<td width="150"><input type="text" name="flcode" id="flcode" class="form-control radius" placeholder="编码......"></td>
								      			...
								      			<td width="85"   class="pr-0 "><input type="text" name="minSellprice" id="minSellprice"  class="form-control radius" placeholder="最小价......."></td>
								      			<td width="20" align="center" class="pr-0 pl-0"><span class="glyphicon glyphicon-resize-horizontal"></span></td>
								      			<td width="85"  class="pl-0"><input type="text" name="maxSellprice" id="maxSellprice" class="form-control " placeholder="最大价......"></td>
                        ...
                        <div class="detail-content">
                        	 <table id="detailtable" data-height="300" data-mobile-responsive="true">
                                </table>
                        </div>
                    </div>
        </div>
   ...
   <jsp:include page="jsPage.jsp"></jsp:include> 
	<script src="${pageContext.request.contextPath}/js/relevancefl.js"></script>
</body>
</html>