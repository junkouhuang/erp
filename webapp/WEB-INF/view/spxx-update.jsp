...
<body style="overflow:hidden;">
	<div class="easyui-tabs" style="width:99%;height:600px;margin-left:4px;">
				...
				<div style="float: left">
					<table style="margin-top: 10px;" cellpadding="5">
						<tr>
							...
							<td  class="pb-3">
								<select disabled="disabled" id='spxxtradeid' class='easyui-combobox'  data-options="width:154,required:true,missingMessage:'请选择品牌商'">
								</select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="pb-3" style="display: none">是否可退: </td>
							<td class="pb-3" style="display: none">
		...
		<div title="明细" style="padding:1px">
			<table id="dg" class="easyui-datagrid" data-options="onClickCell: onClickRowDg,width:550,height:373,singleSelect:true,">
				<thead>
					<tr>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/spxx-update.js"></script>
</body>
</html>