...
<body class="gray-bg">
                        ...
                        <div class="ibox-content  mb-1">
                           		<div class="">
						            <form class="form-horizontal"  id="commentForm" >
										<table class="table "  data-show-columns="false">
											<tr>
												...
												<td width="150"><input type="text" name="flcode" id="flcode" class="form-control radius" placeholder="编码"></td>
								      			<td width="100"><input type="text" name="barcode" id="barcode"  class="form-control radius" placeholder="条码"></td>
								      			<td width="80"  class="pr-0"><input type="text" name="minSellprice" id="minSellprice"  class="form-control radius"  placeholder="最小价"></td>
								      			<td width="20" align="center" class="p-0"><span class="glyphicon glyphicon-resize-horizontal" ></span></td>
								      			<td width="80" class="pl-0"><input type="text" name="maxSellprice" id="maxSellprice" class="form-control " placeholder="最大价"></td>
								      			<td width="60"><input class="btn btn-primary  layer-date" type="button" value="搜索" onclick="LoadingDataListOrderRealItems()"></td>
								      		</tr>
							      	</table>
									</form>
						        </div>
	...
	<script src="${pageContext.request.contextPath}/js/flfhorder-upd-fl.js"></script>
</body>
</html>