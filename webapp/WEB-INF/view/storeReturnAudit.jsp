...
<body>
<div style="">
    <%--<div style="height: 20px; padding: 10px 0px 0px 20px;">
        <div style="width: 250px; float: left;">
            <span style="font-size: 20px;">包数量：</span>
            <span style="font-size: 20px;" id="pakNum"></span>
        </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/storeReturnAudit.js" ></script>
</html>