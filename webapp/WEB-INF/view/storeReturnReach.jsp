...
<body>
<div class="animated fadeInRight"  style="padding-left: 10px;padding-top: 10px;">
<table align="center">
    <tr>
        <td>
            <select class="combobox form-control" type="text" name="whsid" id="whsid"/>
        </td>
        <td>
            &nbsp;	&nbsp;	&nbsp;	&nbsp;	&nbsp;	&nbsp;
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/storeReturnReach.js"></script>
</html>