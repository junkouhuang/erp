    ...
    <form class="form-inline" id="fhorderform">
        <div>
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="ordercode" value="${fhorder.ordercode}" disabled="disabled">
            </div>
            <div class="input-group">
                <div class="input-group-addon">店号</div>
                <input type="text" class="form-control" id="mdcode" value="${fhorder.mdcode}" disabled="disabled"
                       style="width: 100px">
            </div>
            <div class="input-group">
                <div class="input-group-addon">店名</div>
                <input type="text" class="form-control" id="mdmc" value="${fhorder.mdmc}" disabled="disabled"
                       style="width: 370px">
            </div>
            <div class="input-group" style="cursor:pointer;">
                <span onclick="openFlfhorderBystoreid();" style="width:300px; height:20px; line-height:20px; text-align:center; display:block;color: red;">${msg}</span>
            </div>
        </div>
        <hr style="margin-top: 2px;margin-bottom: 2px"/>
        <div>
            <div class="input-group">
                <div class="input-group-addon">物流袋数</div>
                <input type="text" class="form-control" id="fhtotalbagsl" value="${fhorder.fhtotalbagsl}"
                       disabled="disabled" style="width: 50px">
            </div>
            <%-- <div class="input-group">
                 <div class="input-group-addon">物流公司</div>
                 <input type="text" class="form-control" id="wlgs" name="wlgs" style="width: 598px">
             </div>--%>
        </div>
    </form>
</div>
...
<!--请在下方写此页面业务相关的脚本-->
<script src="${pageContext.request.contextPath}/js/fhorder-cusaudit.js"></script>
</html>
