...
<body class="gray-bg">
                ...
                <div class="ibox ">
                        	...
                        	<div class="row" >
                                 ...
                                 <div class="col-lg-2 col-md-2 ">
							      ...
							      <div class="col-lg-2 col-md-2  text-right pt-7" >
										  ...
										  <input class="spCodeOrMxCode" type="radio" name="spCodeOrMxCode" value="spcode" checked="checked"> 款号
										</label>
										<label class="radio-inline">
										  <input class="spCodeOrMxCode" type="radio" name="spCodeOrMxCode" value="mxcode"> 条码
										</label>
								  </div>
						          <div class="col-lg-2 col-md-2 ">  
						        	 <input class="btn btn-primary  layer-date" type="button" value="搜索" onclick="LoadingStoreReturn()">
						          </div>  
							</div>
							</form>
                        </div>
                        <div class="ibox-content">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                     <button onclick="printStoreReturn()" class="btn btn-outline btn-default">
                                ...
                                <table  class="tab_css_1" id="store_return_report" data-height="510" data-mobile-responsive="true">
                                </table>
                        </div>
                        <!-- End Example Events -->
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/store_return_report.js" ></script>
