...
<body style="overflow:hidden;">
	...
	<div class="button" style="margin: 10px 0px; margin-left: 280px;">
		...
		<button type='button' class='btn btn-success' onclick='saveMx()'>保存</button>
	</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/cgd-mxOperate.js"></script>
