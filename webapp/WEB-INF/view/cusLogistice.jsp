                    ...
                    <form class="form-horizontal m-t" id="commentForm">
                        <div class="row">
                            <div class="col-lg-1 col-md-1  text-right pt-7">
                                <label for="wlgsList"></label>
                            </div>
                            <div class="col-lg-2 col-md-2 ">
                                <select class="combobox form-control" name="wlgsList" id="wlgsList">
                                </select>
                            </div>
                        </div>
                    </form>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/cusLogistice.js"></script>
</body>
</html>