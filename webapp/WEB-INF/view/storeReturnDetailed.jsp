...
<body>
<div>
	<table id="storeReturnDetailedTable" data-height="510" data-mobile-responsive="true">
    </table>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/storeReturnDetailed.js" ></script>
