...
<div class="page-container">
	<fieldset>
		<form id="addFlGysFrom"  class="p-20">
			<table class="table">
				<tr>
					<td width="110" class="glyphicon-asterisk">名称:</td><td width="300"><input type="text" name="flgysmc" id="flgysmc" class="form-control radius"></td>
				...
				<tr>
					...
					<td>
				   		<select name="province" class="province3 form-control" id="province"></select>
					</td>
					<td class="glyphicon-asterisk">市：</td>
					<td>
						<select name="city" class="city3 form-control"  id="city"></select>
				   		<!-- <select name="city" class="city3 form-control" style="width:270px;float:left;" id="city"></select>
				   		<input tyle="text" style="width:85px;float:left;" value="生成编码" class="btn btn-primary radius"  onclick="createCode()"/> -->
				   	</td>
				</tr>
	      		<tr>
	      			<td  width="110" class="glyphicon-asterisk">编码:</td><td><input type="text" name="flgyscode" id="flgyscode"  class="form-control radius"   readonly="readonly"></td>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/flgys-add.js" ></script>
