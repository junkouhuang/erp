...
<body class="gray-bg">
                ...
                <div class="ibox ">
                        	...
                        	<div class="row" >
                                  ...
                                  <div class="col-lg-2 col-md-2  text-right pt-7" >
                                    <label class="radio-inline">
                                        <input class="spcode" type="radio" name="spCodeOrMxCode" value="spcode" checked="checked" id="spcode"> 款号
                                    </label>
                                    <label class="radio-inline">
                                        <input class="mxcode" type="radio" name="spCodeOrMxCode" value="mxcode" id="mxcode"> 条码
                                    </label>
                                  </div>
						          <div class="col-lg-4 col-md-4">  
						        	 <input class="btn btn-primary  layer-date" type="button" value="搜索" onclick="LoadingFhInfo()">
						          </div>  
							</div>
							</form>
                        </div>
                        <div class="ibox-content">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                     <button onclick="printSendGoods()" class="btn btn-outline btn-default">
                                ...
                                <table  class="tab_css_1" id="store_send_report" data-height="510" data-mobile-responsive="true">
                                </table>
                        </div>
                        <!-- End Example Events -->
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/store_send_report.js" ></script>
