...
<body class="gray-bg">
                        ...
                        <div class="ibox-title">
                          <form class="form-horizontal m-t">
                        	<div class="row" >  
							      ...
							      <div class="col-lg-2 col-md-2 ">  
							        <input class="form-control layer-date" id="batchcode" type="text" placeholder="批次号" >  
							      </div>
						          <div class="col-lg-4 col-md-3 ">  
						        	 <input class="btn btn-primary  layer-date" type="button" value="搜索" onclick="LoadingDataListRealItems()">
						          </div>  
							</div>
                        </div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/merchandise_sales_report.js" ></script>
