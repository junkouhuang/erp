...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="loading" class="my-wait" style="display:none"></div>
    <div id="wrapper">
        <!--左侧导航开始-->
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/img/profile_small.jpg"  height="64"/></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">${username }</strong></span>
                                <span class="text-muted text-xs block">${groupname }<b class="caret"></b></span>
                                </span>
                            </a>
                        ...
                        <div class="logo-element">Silo
                        </div>
                    </li>
                    <c:forEach items="${menus}" var="webmenu">
                        <li>
                            <a href="#">
                                <i class="${webmenu.icon }"></i>
                                <span class="nav-label">${webmenu.text }</span>
                                <span class="fa arrow"></span>
                            </a>
                            <ul class="nav nav-second-level">
                        <c:forEach items="${webmenu.childlist}" var="childmenu">
                                <li>
                                    <a class="J_menuItem" href="${childmenu.url }" data-index="0">${childmenu.text }</a>
                                </li>
                        </c:forEach>
                            </ul>
                        </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="adminController/logOut" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="welcome" frameborder="0" data-id="welcome.jsp" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2014-2018 <a href="http://www.xileku.com/" target="_blank">silo's blog</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
