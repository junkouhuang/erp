...
<div class="ml-5" style="width:690px">
	<table id="dg" class="easyui-datagrid" title="Row Editing in DataGrid" style="width:690px;height:280px"
			data-options="
				iconCls: 'icon-edit',
				singleSelect: true,
				toolbar: '#tb',
		...
		<thead>
			<tr>
			    ...
			    <th data-options="field:'flid',width:80,align:'center',hidden:'true'">flid</th>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/flmobaninfo-upd.js" ></script>
</html>
